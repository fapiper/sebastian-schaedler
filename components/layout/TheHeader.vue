          ...
          <ul class="hidden w-full lg:flex items-center space-x-8">
            ...
            <li class="!ml-auto">
              <NuxtLink class="flex items-center space-x-2" to="/contact">
                ...
                <span>Kontakt aufnehmen</span></NuxtLink
              >
            </li>
          </ul>
          <button
...
<style lang="postcss">
.menu-button {
  @apply h-9 w-9 ml-auto flex items-center justify-center lg:hidden pointer-events-auto;
}
...
.menu-button span {
  @apply absolute block h-px w-full bg-white left-0 transition-all duration-500 ease-in-out;
}
