  ...
  <div>
    ...
    <section>
      <div class="container mx-auto px-4 lg:max-w-5xl">
        ...
        <h4>Umsetzung & Entwicklung</h4>
        <p>NXT YOU GmbH</p>

        <h4>Haftungsbeschränkung</h4>
        <p>
          Durch Ihre Nutzung dieser Website erklären Sie Ihr Einverständnis,
          diese Website auf eigene Gefahr zu nutzen. Sebastian Schädler haftet
          nicht für direkte, indirekte oder andere Schaden oder Kosten,
          einschließlich entgangenem Gewinn oder dem Verlust von Daten, Ansehen
          oder Eigentumsverletzungen oder für Ansprüche Dritter aus oder im
          Zusammenhang mit der Nutzung, dem Kopieren oder der Wiedergabe dieser
          Website oder deren Inhalte, unabhängig davon, ob Sebastian Schädler
          über diese Möglichkeit unterrichtet hat.
        </p>
        ...
        <p>
          Der Inhalt dieser Website, einschließlich des Designs, Textes, der
          Graphiken sowie deren Auswahl und Zusammenstellung ist Eigentum von
          Sebastian Schädler. Das Copyright für diese Website liegt bei
          Sebastian Schädler.
        </p>
        <h4>Disclaimer</h4>
        <p>
          Sebastian Schädler übernimmt keine Gewähr für die Aktualität,
          Richtigkeit und Vollständigkeit der auf dieser Website
          bereitgestellten Informationen. Gleiches gilt auch für die Inhalte
          externer Websites, auf die diese Website über Hyperlinks direkt oder
          indirekt verweist und auf Sebastian Schädler keinen Einfluss hat.
        </p>
      </div>
    </section>
    <section>
      <div class="container mx-auto px-4 lg:max-w-5xl">
        <div>
          <h2 class="title text-yellow mb-4 lg:mb-8">Datenschutzerklärung</h2>
          ...
          <p>
            ...
            zukünftigen Besuchen dieser Website verhindert:&nbsp;<a
          ...
          <p>
            ...
            ersehen Sie unter folgendem Link:&nbsp;<a
              target="_blank"
              rel="noopener"
          ...
          <p>
            ...
            deren Datenschutzerklärung unter:&nbsp;<a
              target="_blank"
              rel="noopener"
