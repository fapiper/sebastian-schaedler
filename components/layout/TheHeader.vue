  ...
  <header>
    <nav ref='navbar' class='fixed top-0 left-0 w-full z-40 bg-blue'>
      <div class='container px-4 lg:max-w-5xl mx-auto'>
        <ul class='w-full flex h-20 items-center space-x-8 uppercase font-light text-sm'>
          <li>
          ...
          <li class='!ml-auto'>
            <a class='flex items-center space-x-2' href='/'>
              <svg class='block w-4 text-yellow' fill='currentColor' viewBox='0 0 308 308'>
                <path
...
export default {
  mounted() {
    const showAnim = this.$gsap.from(this.$refs.navbar, {
      yPercent: -100,
      paused: true,
      duration: 0.2
    }).progress(1)
